...
export const metadata: Metadata = {
  title: "Investor information | Meridian Freight",
  description:
    "How to reach Meridian Freight regarding investment, partnership, or strategic inquiries.",
};
...
export default async function InvestorsPage() {
  ...
  const content: CompanyPageContent = {
    ...
    intro:
      "Meridian Freight is privately held. We don't publish public financial filings or trade on a public exchange, but we're always open to conversations with investors and strategic partners who share our view of where freight forwarding is headed.",
    sections: [
      {
        type: "prose",
        heading: "Investment and partnership inquiries",
        paragraphs: [
          "If you're an investor, financial institution, or potential strategic partner looking to discuss Meridian Freight — funding, partnership structures, or broader strategic collaboration — we'd like to hear from you. Reach out through our contact form and let us know the nature of your inquiry so it reaches the right person on our leadership team.",
        ],
      },
      {
        type: "prose",
